class Lease:
    def __init__(self, lease_id, property_number, start_date, end_date,units, lease_type=None,status=None):
    ...
    def __str__(self):
        return (f"Lease #{self.lease_id} ({self.lease_type}) for Property #{self.property_number}, "
